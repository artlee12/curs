...
python scripts/train.py --model bert --epochs 3 --batch-size 16

# Быстрый sanity-check (1 эпоха)
python scripts/train.py --model bert --epochs 1 --batch-size 16

# CNN + Word2Vec-style embeddings
