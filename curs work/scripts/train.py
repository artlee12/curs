...
def train_model(model_name: str, config, X_train, y_train, X_val, y_val, logger, artifact_manager, use_gpu: bool = True):
    ...
    if model_name == "tfidf_logreg":
        ...
        model_config = {
            ...
            'epochs': 3,
            'batch_size': 64 if use_gpu else 16,  # Больший batch на GPU
            'learning_rate': 2e-5,
